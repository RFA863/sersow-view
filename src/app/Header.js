      ...
      <div className="flex justify-between">
        <div className="flex items-center">
          ...
          <Link
            id="homeBtn"
            href="/home"
            className={`${font.Satoshi_b2medium} pl-8 text-slate-200 transition ease-out delay-150 hover:drop-shadow-[0_0_20px_rgba(255,255,255,0.4)] active:scale-[.92] active:delay-150`}
          >
            Home
          </Link>
        </div>
